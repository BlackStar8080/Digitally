                            ...
                            <form method="GET" action="{{ route('players.index') }}" class="filters-group">
                                ...
                                <select name="position" class="filter-select" onchange="this.form.submit()">
                                    ...
                                    <option value="Shooting Guard"
                                        {{ request('position') == 'Shooting Guard' ? 'selected' : '' }}>Shooting Guard
                                    </option>
                                    <option value="Point Guard"
                                        {{ request('position') == 'Point Guard' ? 'selected' : '' }}>
                                        Point Guard</option>
                                    <option value="Center" {{ request('position') == 'Center' ? 'selected' : '' }}>Center
                                    </option>
                                    <option value="Small Forward"
                                        {{ request('position') == 'Small Forward' ? 'selected' : '' }}>Small Forward
                                    </option>
                                    <option value="Power Forward"
                                        {{ request('position') == 'Power Forward' ? 'selected' : '' }}>Power Forward
                                    </option>
                                    ...
                                    <option value="Middle Blocker"
                                        {{ request('position') == 'Middle Blocker' ? 'selected' : '' }}>Middle Blocker
                                    </option>
                                    <option value="Outside Hitter"
                                        {{ request('position') == 'Outside Hitter' ? 'selected' : '' }}>Outside Hitter
                                    </option>
                                    <option value="Opposite Hitter"
                                        {{ request('position') == 'Opposite Hitter' ? 'selected' : '' }}>Opposite Hitter
                                    </option>
                                    <option value="Opposite" {{ request('position') == 'Opposite' ? 'selected' : '' }}>
                                                ...
                                                @if (!session('is_guest'))
                                                    <div class="action-buttons">
                                                        <button type="button" class="btn-action btn-edit"
                                                            ...
                                                            data-birthday="{{ $player->birthday }}" title="Edit Player">
                                ...
                                <div style="flex:1; min-width: 0;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="playerName" class="form-control"
                                            value="{{ old('name') }}" required placeholder="Enter player name"
                    ...
                    playerNameInput.addEventListener('blur', async function() {
                        ...
                        if (name && teamId) {
                            const response = await fetch(
                                `/check-player?name=${encodeURIComponent(name)}&team_id=${teamId}`);
