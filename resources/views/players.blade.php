                                    ...
                                    @forelse($players as $player)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($player->number)
                                                    <span
                                                        style="background: var(--primary-blue); color: white; padding: 2px 8px; border-radius: 4px; font-weight: 600; font-size: 12px;">
                                                        #{{ $player->number }}
                                                    </span>
                                                @else
                                                    -
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                window.openModal = function() {
                    ...
                    modalTitleEl.textContent = "Add New Player";
