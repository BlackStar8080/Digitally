                    ...
                    <div class="controls-section">
                        ...
                        <div class="actions-group">
                            <div class="search-container">
                                <input type="text" id="searchInput" class="search-input" placeholder="Search teams...">
                            ...
                            <tbody id="teamTable">
                                @forelse($teams as $team)
                                    <tr class="fade-in-row">
                                        ...
                                        <td>{{ $team->sport ? $team->sport->sports_name : 'N/A' }}</td>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <div class="empty-state">
                                                ...
                                                <p>Check back later for more teams.</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function filterTable() {
                ...
                document.querySelectorAll('#teamTable tr').forEach(row => {
                    ...
                    const sport = row.querySelector('td:nth-child(2)')?.textContent.toLowerCase() || '';
                    ...
                    row.style.display = (matchesSearch && matchesSport) ? '' : 'none';
                });
            }
            ...
            document.querySelectorAll('#teamTable tr').forEach((row, index) => {
